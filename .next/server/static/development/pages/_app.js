...
/* harmony import */ var local_storage__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! local-storage */ "local-storage");
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(MyApp, [{
    ...
    value: function render() {
      var _this$props = this.props,
          Component = _this$props.Component,
          pageProps = _this$props.pageProps;
      var isBrowser = typeof window !== "undefined"; // this means that we are now running on client but it is first page load, not
      // a redirect to this page

      if (pageProps && pageProps.isServer && isBrowser) {
        local_storage__WEBPACK_IMPORTED_MODULE_10___default.a.set("userInfo", pageProps.user);
      }
    ...
    value: function () {
      var _getInitialProps = Object(_babel_runtime_corejs2_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__["default"])( /*#__PURE__*/_babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee(_ref) {
        var Component, router, ctx, pageProps, isServer, user;
            ...
            switch (_context.prev = _context.next) {
              ...
              case 6:
                ...
                if (isServer) {
                  ...
                  try {
                    user = local_storage__WEBPACK_IMPORTED_MODULE_10___default.a.get("userInfo");
                  } catch (e) {
                    user = {};
                  }
