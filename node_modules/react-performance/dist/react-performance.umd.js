(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-redux'), require('redux-batched-subscribe')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-redux', 'redux-batched-subscribe'], factory) :
	(factory((global.ReactPerformance = {}),global.React,global.ReactRedux,global.reduxBatchedSubscribe));
}(this, (function (exports,React,ReactRedux,reduxBatchedSubscribe) { 'use strict';
    ...
    createClass(Measured, [{
      ...
      value: function logChanges(changeDetails) {
        ...
        changeDetails.forEach(function (changeDetail) {
          console.log('Changed prop %o: %o → %o', changeDetail.key, changeDetail.prevValue, changeDetail.value);
        });
      }
    }]);
    return Measured;
...
var connect$1 = function connect$$1(_ref) {
  ...
  return ReactRedux.connect(mapStateToProps, mapDispatchToProps)(measure({ getId: getId, Component: Component$$1, isCollapsed: isCollapsed }));
};
...
var createNotifier = function createNotifier() {
  ...
  return reduxBatchedSubscribe.batchedSubscribe(debounce({ wait: 5, method: function method(notify) {
